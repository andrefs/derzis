...
const updatePaths = async function(sourceUrl, triples){
      console.log('XXXXXXXXXXXXXXXXXXXXXXXXxx 7 updatePaths', sourceUrl);
  let paths = await Path.find({'head.url': sourceUrl, status: 'active'}).lean();
  for(const path of paths){
      console.log('XXXXXXXXXXXXXXXXXXXXXXXXxx 8 updatePaths for');
...
const addHeads = async function(path, triples){
      console.log('XXXXXXXXXXXXXXXXXXXXXXXXxx 9 addHeads');
  let newPaths = {};
  for(const t of triples){
    if(t.subject === 'http://dbpedia.org/resource/Aveyron'){
      console.log('XXXXXXXXXXXXXXXXXXXXXXXXxx 9.5', t);
    }
    if(t.object === 'http://dbpedia.org/resource/Aveyron'){
      console.log('XXXXXXXXXXXXXXXXXXXXXXXXxx 9.6', t);
    }
    ...
    if(!newPaths[prop][newHead]){
      ...
      if(np.head.url === 'http://dbpedia.org/resource/Aveyron'){
        console.log('XXXXXXXXXXXXXXXXXXXXXXXXxx 10', np);
      }
    }
  }
  ...
  const paths = await Path.create(nps);
