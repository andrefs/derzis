...
const updatePaths = async function(sourceUrl, triples){
  //console.log('XXXXXXXXXXXXXXXXx updatePaths');
  //console.log('XXXXXXXXXXXXXXXXx before Path.find');
  const query = {'head.url': sourceUrl, status: 'active'};
  let paths = await Path.find(query);
  //console.log('XXXXXXXXXXXXXXXXx before Path.updateMany');
  await Path.updateMany(query, {status: 'finished'});
  for(const path of paths){
    //console.log('XXXXXXXXXXXXXXXXx before addHeads');
...
const addHeads = async function(path, triples){
    //console.log('XXXXXXXXXXXXXXXXx addHeads');
  let newPaths = {};
  let newHeads = {};
  ...
  if(!nps.length){ return; }
    ...
    //console.log('XXXXXXXXXXXXXXXXx before Paths.create');
  let paths = await Path.create(nps);
  paths = paths.filter(p => p.status === 'active');

  if(paths.length){
    //console.log('XXXXXXXXXXXXXXXXx before Resource.addPaths');
    await Resource.addPaths(paths);

    for(const p of paths){
      if(p.head.alreadyCrawled){
      //console.log('XXXXXXXXXXXXXXXXx before addExistingHead');
...
const addExistingHead = async function(path){
    //console.log('XXXXXXXXXXXXXXXXx addExistingHead');
