          ...
          {#if t.inProcess}
            <div class="triple in-process">
              ...
              {:else}
                ...
                <span
                  id="subject-{i}"
                  class="unvisited-resource {isCurrentResource(t.subject)
                    ? 'current-resource'
                    : ''}"
                >
                  &lt;{t.subject}&gt;
              ...
              {:else}
                ...
                <span
                  id="predicate-{i}"
                  class="unvisited-resource {isCurrentResource(t.predicate)
                    ? 'current-resource'
                    : ''}"
                >
                  &lt;{t.predicate}&gt;
              ...
              {:else}
                ...
                <span
                  id="object-{i}"
                  class="unvisited-resource {isCurrentResource(t.object) ? 'current-resource' : ''}"
                >
                  &lt;{t.object}&gt;
                </span>
              {/if}
