...
export default {
	...
	graph: {
		maxPathLength: Number(getSecret('MAX_PATH_LENGTH')) || Number(process.env.MAX_PATH_LENGTH) || 2,
		maxPathProps: Number(getSecret('MAX_PATH_PROPS')) || Number(process.env.MAX_PATH_PROPS) || 1
	},
	pubsub: {
		debug: false,
