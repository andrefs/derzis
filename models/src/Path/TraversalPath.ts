...
class TraversalPathClass extends PathClass {
	...
	public async extendWithExistingTriples(process: ProcessClass): Promise<{ extendedPaths: TraversalPathSkeleton[]; procTriples: Types.ObjectId[] }> {
		...
		return this.genExtended(triples, process) as Promise<{ extendedPaths: TraversalPathSkeleton[]; procTriples: Types.ObjectId[] }>;
	}
