...
class EndpointPathClass extends PathClass {
	...
	public async extendWithExistingTriples(process: ProcessClass): Promise<{ extendedPaths: EndpointPathSkeleton[]; procTriples: Types.ObjectId[] }> {
		...
		return this.genExtended(triples, process) as Promise<{ extendedPaths: EndpointPathSkeleton[]; procTriples: Types.ObjectId[] }>;
	}
